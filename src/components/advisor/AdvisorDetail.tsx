  ...
  return (
    <div className="flex-1 flex flex-col bg-[#f6f7f8] min-h-screen pb-24">
      <header className="sticky top-0 z-10 bg-white/90 backdrop-blur-md border-b border-slate-200 px-4 py-4 flex items-center">
        ...
        <h1 className="ml-4 text-2xl font-black text-slate-900">我的顾问</h1>
      </header>

      <main className="flex-1 overflow-y-auto pb-8">
        <section className="bg-white mt-4 mx-4 p-8 rounded-3xl shadow-sm border border-slate-100 text-center">
          ...
          <h2 className="mt-4 text-5xl font-black text-slate-900">小王</h2>
          <p className="text-[#13a4ec] font-bold text-3xl mt-1">高级保险理财顾问</p>

          <div className="mt-4 inline-flex items-center px-4 py-2 rounded-full bg-[#13a4ec]/10 text-[#13a4ec] text-lg font-bold">
          ...
          <div className="mt-4 flex justify-center items-center gap-1">
            {[...Array(5)].map((_, i) => (
              <Star key={i} size={28} className="text-[#13a4ec] fill-[#13a4ec]" />
            ))}
            <span className="ml-2 text-3xl font-bold text-slate-500">5.0</span>
          </div>
        </section>

        <section className="mt-6 px-4">
          <div className="bg-white rounded-3xl border border-slate-100 p-6">
            <h3 className="text-4xl font-black mb-4 flex items-center text-slate-900">
              <BadgeCheck size={22} className="text-[#13a4ec] mr-2" />
              服务擅长
            </h3>
            <div className="flex flex-wrap gap-3">
              {expertise.map((item) => (
                <span key={item} className="px-4 py-2 bg-slate-100 rounded-xl text-lg text-slate-900">
                  {item}
                </span>
              ))}
            </div>
            ...
            <h3 className="text-4xl font-black mb-3 flex items-center text-slate-900">
        ...
        <section className="mt-6 px-4 grid grid-cols-1 gap-4">
          ...
          >
            ...
            <span className="text-3xl font-black">电话咨询顾问</span>
          </a>
          ...
          >
            ...
            <span className="text-3xl font-black">在线聊天</span>
          </button>
        </section>
